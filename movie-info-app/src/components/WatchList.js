...
import { getMovies, deleteMovie, getMultipleMovieRecommendations } from "../actions/movieActions";
...
export default connect(mapStateToProps, { getMovies, deleteMovie, getMultipleMovieRecommendations } )(WatchList);